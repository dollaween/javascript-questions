...
##### 1. Что такое нотация О большое (Big O notation)?
...
##### 2. Как работает и какие задачи решает алгоритм Frequency Counter?

<details><summary><b>Ответ</b></summary>
<p>

**Frequency Counter** — этот паттерн использует объекты для хранения значений/частотности значений. Позволяет избежать квадратичной сложности O(N^2) вложенных циклов или операций с массивами/строками.
